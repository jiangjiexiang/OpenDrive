...
"      if (document.getElementById('object-filters')) return;\n"
"\n"
"      var wrap = document.createElement('div');\n"
"      wrap.id = 'object-filters';\n"
...
"        var noObj = document.createElement('span');\n"
"        noObj.style.color = '#666';\n"
"        noObj.textContent = ' 无对象';\n"
"        wrap.appendChild(noObj);\n"
"      } else {\n"
"        // Select / Clear buttons\n"
"        var selectAll = document.createElement('button');\n"
"        selectAll.className = 'tool';\n"
"        selectAll.style.padding = '4px 8px';\n"
"        selectAll.textContent = '全选';\n"
"        selectAll.addEventListener('click', function(){\n"
"          document.querySelectorAll('#object-filters input[type=checkbox]').forEach(function(cb){ cb.checked = true; cb.dispatchEvent(new Event('change')); });\n"
"        });\n"
"        var clearAll = document.createElement('button');\n"
"        clearAll.className = 'tool';\n"
"        clearAll.style.padding = '4px 8px';\n"
"        clearAll.textContent = '清除';\n"
"        clearAll.addEventListener('click', function(){\n"
"          document.querySelectorAll('#object-filters input[type=checkbox]').forEach(function(cb){ cb.checked = false; cb.dispatchEvent(new Event('change')); });\n"
"        });\n"
...
"            objs.forEach(function(el){\n"
"              var et = el.getAttribute('data-obj-type') || el.getAttribute('data-elem-tag') || 'unknown';\n"
"              if (et === t) {\n"
...
"    }\n"
"\n"
"    // init after page load (objects may already be present)\n"
"    window.addEventListener('load', function(){ setTimeout(initObjectFilters, 50); });\n"
"    // expose to allow re-scan if parser injects objects later\n"
